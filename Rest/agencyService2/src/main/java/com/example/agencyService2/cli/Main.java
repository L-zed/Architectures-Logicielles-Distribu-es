package com.example.agencyService2.cli;
...
public class Main {
    ...
    public void runCLI() {
        ...
        String agencyName = proxy.getForObject("http://localhost:8083/agency2/", Agency.class).getName();
        System.out.println("Welcome to " + agencyName);

        Hotel[] hotels = proxy.getForObject("http://localhost:8083/agency2/hotels", Hotel[].class);
        ...
        for (Hotel h : hotels) {
            ...
            String uriOffer = "http://localhost:8083/agency2/offers/" + agencyId + "/agency2/" + dateA + "/" +
        ...
        if (nbOffres > 0) {
            ...
            String uriReservation = "http://localhost:8083/agency2/reservation/" + hotelId + "/" + idOffer + "/" + firstNameClient
                    + "/" + lastNameClient;
