...
public abstract class ComplexUserInputProcessor <T>{
    //ATTRIBUTS
    protected String message ; //the message sent to the user to specify the type of the parameter
    protected BufferedReader inputReader; // allow the user to enter data
    protected Method parser;
    protected Predicate<String> isValid; //to check if the value entered is ok
