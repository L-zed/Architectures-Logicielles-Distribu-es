...
import wsdl_agence.OffresAggregeesService;
...
public abstract class AbstractMain {
    ...
    protected abstract void processUserInput(BufferedReader inputReader, String userInput, OffresAggregeesService proxy);
}
