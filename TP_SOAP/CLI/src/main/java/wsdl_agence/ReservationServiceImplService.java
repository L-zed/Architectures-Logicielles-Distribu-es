 ...
 * 
 */
@WebServiceClient(name = "ReservationServiceImplService", targetNamespace = "http://services/", wsdlLocation = "http://localhost:3000/reservationservice?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:3000/reservationservice?wsdl");
