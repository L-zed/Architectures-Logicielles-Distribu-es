 ...
 * 
 */
@WebServiceClient(name = "HotelServiceImplService", targetNamespace = "http://services/", wsdlLocation = "http://localhost:8080/hotelserviceacapulco?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HOTELSERVICEIMPLSERVICE_QNAME = new QName("http://services/", "HotelServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/hotelserviceacapulco?wsdl");
    ...
    public HotelService getHotelServiceImplPort() {
        return super.getPort(new QName("http://services/", "HotelServiceImplPort"), HotelService.class);
    }
    ...
    public HotelService getHotelServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services/", "HotelServiceImplPort"), HotelService.class, features);
    }
