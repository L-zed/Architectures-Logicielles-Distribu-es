 ...
 * 
 */
@WebServiceClient(name = "ReservationServiceImplService", targetNamespace = "http://services/", wsdlLocation = "http://localhost:8080/reservationserviceacapulco?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RESERVATIONSERVICEIMPLSERVICE_QNAME = new QName("http://services/", "ReservationServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/reservationserviceacapulco?wsdl");
    ...
    public ReservationService getReservationServiceImplPort() {
        return super.getPort(new QName("http://services/", "ReservationServiceImplPort"), ReservationService.class);
    }
    ...
    public ReservationService getReservationServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services/", "ReservationServiceImplPort"), ReservationService.class, features);
    }
